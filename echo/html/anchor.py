...
class Anchor(Element):
    """
    This is a class to simulate HTML anchor or hyperlink object
    interactions.
    ...
    def __init__(
        self, browser, by, value, parent_instance=None, attributes=[], sub_elements=[]
    ):
        """
        Init
...
Anchor.generate_attributes_properties(
    ["download", "href", "hreflang", "media", "rel", "target", "title"]
)
